...
public class BluetoothListActivity extends ActionBarActivity implements BluetoothAdapter.LeScanCallback {
    ...
    public void scanDevice() {
        ...
        if (mBluetoothAdapter == null || !mBluetoothAdapter.isEnabled()) {
            ...
            mHandler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    mBluetoothAdapter.stopLeScan(BluetoothListActivity.this);
            ...
            mBluetoothAdapter.startLeScan(BluetoothListActivity.this);
        }
    }
