...
public class MyoListActivity extends Activity implements BluetoothAdapter.LeScanCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myolist);
    ...
    public void scanDevice() {
        ...
        if (mBluetoothAdapter == null || !mBluetoothAdapter.isEnabled()) {
            ...
            mBluetoothAdapter.startLeScan(MyoListActivity.this);
        }
    }
